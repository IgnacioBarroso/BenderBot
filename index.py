...
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Streaming(name='ASHEE', url='http://www.twitch.tv/accountname'))
    print('Estoy ready pa')

bot.run('ODU4NTgxNjI3ODE0MDE5MDgy.YNgOcw.t3z2e9SUREfsoFKw69jLl75SvxA')